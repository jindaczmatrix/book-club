...
class OrderLog:
    def __init__(self, order_number, status = OrderStatus.PENDING) -> None:
...
class ShipmentLog:
    def __init__(self, shipment_number, status=ShipmentStatus.PENDING) -> None:
...
class Shipment:
    def __init__(self, shipment_number, shipment_method):
        ...
        self.estimated_arrival = datetime.date.today()
